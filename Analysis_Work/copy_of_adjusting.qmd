...
loglik_independent <- function(x, ace_abias, not_ace_abias) {
...
independent_model <- optim(par = 0.5,  # Initial guess for the probability of an ace event
                            loglik_independent,
...
loglik_independent_model <- -independent_model$value

# Print the result
cat("Log-likelihood for the independent model:", loglik_independent_model, "\n")
