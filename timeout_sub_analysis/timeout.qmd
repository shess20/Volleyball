...
calculate_win_probability <- function(playByPlay) {
  ...
  total_timeout <- tally(last_timeout)
  
  losing_team_wins_after_last_timeout <- sum(last_timeout$losing_team_wins, na.rm = TRUE)
  total_timeouts <- sum(total_timeout == TRUE, na.rm = TRUE)
...
print(paste("Probability of the losing team winning after the last timeout of the set:", probability))
```
