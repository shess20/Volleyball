...
(Run Final_data_adjusting.qmd first to get the models loaded in the environment)
...
Ho: the independent model is sufficient (for full model)

Ha: the full model is significantly better than the independent model (for full model)
...
loglik_independent_model_full <- -independent_model_full$value  # Negate the result since your function returns negative log-likelihood
